...
public class MorseCodeConverterTestPublic {
	...
	public void testConvertMorseStringToEnglishStringStudent() {	
		...
		String converter1 = MorseCodeConverter.convertToEnglish(".--. .-. --- ..-. . ... ... --- .-. / .-.. --- ...- . ... / .... --- -.-. -.- . -.--");
		assertEquals("professor loves hockey", converter1);
	...
	public void testConvertMorseFileToEnglishStringStudent() {
		...
		File file=new File("src/MorseCode.txt");
		
		try {
			assertEquals("an apple a day keeps the doctors way", MorseCodeConverter.convertToEnglish(file));
		} catch (FileNotFoundException e) {
			assertTrue("An unwanted exception was caught", false);
		}
	}
